...
- The [API Reference](reference/qiu_classical_simulation/index.md) documents every public object, generated from the docstrings, e.g. of the subpackage [`wave_optics`](reference/qiu_classical_simulation/wave_optics/index.md).
