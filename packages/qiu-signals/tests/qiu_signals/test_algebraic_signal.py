...
from qiu_signals.algebraic_signal import (
    AlgebraicSignal,
    PolynomialSignal,
    QuadraticSignal,
)
from qiu_signals.integer_axis import IndexOrdering
from qiu_signals.physical_axis import PhysicalAxis, PositionAxis
...
class TestAlgebraicSignalWithoutSympy:
    ...
    def test_missing_sympy(self, monkeypatch: pytest.MonkeyPatch):
        ...
        axis = PositionAxis(4, 1.0, IndexOrdering.NATURAL)
        with pytest.raises(ImportError, match=r"qiu-signals\[sympy\]"):
