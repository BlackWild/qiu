...
- The [API Reference](reference/qiu_hamiltonian_simulation/index.md) documents every module: [`time_independent.direct`](reference/qiu_hamiltonian_simulation/time_independent/direct.md), [`time_independent.sample_based`](reference/qiu_hamiltonian_simulation/time_independent/sample_based.md) and [`time_independent.fourier`](reference/qiu_hamiltonian_simulation/time_independent/fourier.md).
